...
const CHAIR_MODEL_PATH = '/models/office_chair/scene.gltf'

export default function OfficeChair({ position = [0, 0, 0], rotation = [0, 0, 0], scale = 1 }) {
  const gltf = useGLTF(CHAIR_MODEL_PATH)
  ...
  const scene = useMemo(() => {
    ...
    // Center the chair on its floor-center so position=[0,0,0] places it at origin
