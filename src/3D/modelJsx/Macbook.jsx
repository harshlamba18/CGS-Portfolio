...
const MAC_MODEL_PATH = '/models/macbook/scene.gltf'

export default function Macbook({ position = [0, 0, 0], rotation = [0, 0, 0], scale = 1 }) {
  const gltf = useGLTF(MAC_MODEL_PATH)
...
useGLTF.preload(MAC_MODEL_PATH)
